  ...
  return (
    <div className="min-h-full space-y-6 bg-white p-1 lg:p-2">
      <div className="flex items-center justify-between">
           ...
           <div><h1 className="font-sf-display text-[22px] font-bold tracking-tight text-black">Order detail</h1><p className="mt-1 text-[13px] text-black/45">{orderNumberLabel(order?.order_number)}</p></div>
        </div>
      </div>
