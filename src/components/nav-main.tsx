...
function SidebarLabel({ text, active }: { text: string; active?: boolean }) {
    return (
        <span className={cn(
            ...
            active ? "font-semibold text-[#1a1a1a]" : "font-medium text-[#666]"
        )}>
            {text}
        </span>
    );
...
const activeNavItemClass =
    "bg-[#D1D1D1] hover:!bg-[#D1D1D1] !rounded-lg border-[1.5px] border-black/[0.28] text-[#1a1a1a] shadow-[0_2px_6px_rgba(0,0,0,0.03),inset_0_1px_0_rgba(255,255,255,0.7)]";
