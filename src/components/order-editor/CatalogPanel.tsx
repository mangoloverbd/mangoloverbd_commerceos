          ...
          return (
            <article key={product.id} className="rounded-xl bg-white p-5 ring-1 ring-inset ring-black/[0.06]">
              <div className="flex gap-4">
                <div className="grid h-[72px] w-[72px] shrink-0 place-items-center overflow-hidden rounded-xl bg-black/[0.04]">
                  {image ? <img src={image} alt={product.name} className="h-full w-full object-cover" /> : <Package weight="light" size={24} className="text-black/25" />}
                </div>
