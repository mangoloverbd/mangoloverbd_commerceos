            ...
            routes: [
                {
                    id: "returns",
                    title: "Returns",
                    icon: <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 50 50" fill="currentColor" className={iconCls}><path d="M33.883,27.946c-0.67,0-1.283-0.365-1.603-0.953c-0.422-0.775-0.228-1.74,0.464-2.293c1.916-1.539,2.734-3.367,2.816-4.914c-0.582-0.295-1.23-0.479-1.928-0.479h-6.1v10.355l-4.956-3.453l-4.957,3.453V19.308h-6.099c-2.364,0-4.28,1.918-4.28,4.281v15.692c0,2.363,1.916,4.281,4.28,4.281h22.111c2.363,0,4.279-1.918,4.279-4.281V26.206c-1.787,1.076-3.303,1.598-3.457,1.648C34.268,27.915,34.076,27.946,33.883,27.946z M16.76,40.51h-6.061v-2.871h6.061V40.51z M22.577,40.51h-3.903v-2.871h3.903V40.51z"/><path d="M40.878,11.3c-2.271-2.277-6.065-2.469-9.759-2.469l-2.547,0.002V7.456c0-0.951-0.648-1.299-1.441-0.775l-6.487,4.277c-0.794,0.523-0.794,1.381,0,1.902l6.487,4.279c0.793,0.523,1.441,0.174,1.441-0.775v-1.379h4.244c1.879,0,3.305,0.988,3.911,2.713c0.773,2.197,0.121,5.564-3.079,8.135c-0.141,0.113-0.18,0.311-0.094,0.469c0.066,0.123,0.193,0.195,0.328,0.195c0.038,0,0.078-0.006,0.117-0.02c0.356-0.117,8.738-2.973,8.758-9.844C42.764,14.353,42.131,12.558,40.878,11.3z"/></svg>,
                    link: "/returns",
                },
            ],
        };
