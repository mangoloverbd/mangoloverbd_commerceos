            ...
            <SidebarFooter className="border-t-0 p-1.5">
                ...
                <div className={cn("px-2", isCollapsed && "flex justify-center px-0")}>
                    ...
                    >
                        ...
                        {!isCollapsed && (
                            <span className="text-[12px] font-medium text-[#333] transition-colors group-hover/footer-link:text-[#111]">System Settings</span>
                        )}
                    </Link>
                </div>
