        ...
        const product: NavSection = {
            ...
            routes: [
                ...
                },
                {
                    id: "order-chat",
                    title: "AI Chat",
                    icon: <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="#000000" className={iconCls}><g clipPath="url(#clip0_ai_chat)"><path d="M17.98 10.79V14.79C17.98 15.05 17.97 15.3 17.94 15.54C17.71 18.24 16.12 19.58 13.19 19.58H12.79C12.54 19.58 12.3 19.7 12.15 19.9L10.95 21.5C10.42 22.21 9.56 22.21 9.03 21.5L7.83 19.9C7.7 19.73 7.41 19.58 7.19 19.58H6.79C3.6 19.58 2 18.79 2 14.79V10.79C2 7.86 3.35 6.27 6.04 6.04C6.28 6.01 6.53 6 6.79 6H13.19C16.38 6 17.98 7.6 17.98 10.79Z" fill="white" style={{fill: 'var(--fillg)'}}/><path d="M21.98 6.79V10.79C21.98 13.73 20.63 15.31 17.94 15.54C17.97 15.3 17.98 15.05 17.98 14.79V10.79C17.98 7.6 16.38 6 13.19 6H6.79C6.53 6 6.28 6.01 6.04 6.04C6.27 3.35 7.86 2 10.79 2H17.19C20.38 2 21.98 3.6 21.98 6.79Z" fill="white" style={{fill: 'var(--fillg)'}}/><path d="M12.245 13.25C11.555 13.25 10.995 12.69 10.995 12C10.995 11.31 11.555 10.75 12.245 10.75C12.935 10.75 13.495 11.31 13.495 12C13.495 12.69 12.935 13.25 12.245 13.25Z" fill="white" style={{fill: 'var(--fillg)'}}/><path d="M15.745 13.25C15.055 13.25 14.495 12.69 14.495 12C14.495 11.31 15.055 10.75 15.745 10.75C16.435 10.75 16.995 11.31 16.995 12C16.995 12.69 16.435 13.25 15.745 13.25Z" fill="white" style={{fill: 'var(--fillg)'}}/><path d="M8.745 13.25C8.055 13.25 7.495 12.69 7.495 12C7.495 11.31 8.055 10.75 8.745 10.75C9.435 10.75 9.995 11.31 9.995 12C9.995 12.69 9.435 13.25 8.745 13.25Z" fill="white" style={{fill: 'var(--fillg)'}}/></g><defs><clipPath id="clip0_ai_chat"><rect width="24" height="24" fill="white"/></clipPath></defs></svg>,
                    link: "/order-chat",
                },
                {
                    id: "products",
