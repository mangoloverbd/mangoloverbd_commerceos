            ...
            routes: [
                {
                    id: "inbox-facebook",
                    title: "Facebook",
                    icon: <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" className={iconCls}><g fill="none"><path fill="#8fbffa" d="M0 1.077v11.846A1.077 1.077 0 0 0 1.077 14h11.846A1.077 1.077 0 0 0 14 12.923V1.077A1.077 1.077 0 0 0 12.923 0H1.077A1.077 1.077 0 0 0 0 1.077"/><path fill="#2859c5" d="M9.692 8.895V14H7.28V8.895h-.69a.657.657 0 0 1-.667-.657V7.41a.657.657 0 0 1 .668-.657h.689v-1.26a2.498 2.498 0 0 1 2.574-2.8h1.238a.67.67 0 0 1 .646.69v.796a.62.62 0 0 1-.193.464a.59.59 0 0 1-.463.193h-.528c-.41 0-.819 0-.819.905v1.012h.722a.657.657 0 0 1 .657.657v.83a.657.657 0 0 1-.657.656z"/></g></svg>,
                    link: "/inbox/facebook",
                },
                {
                    id: "inbox-instagram",
                    title: "Instagram",
                    icon: <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" className={iconCls}><g fill="none"><path fill="#8fbffa" d="M.786 3.39A2.604 2.604 0 0 1 3.39.787h6.944a2.604 2.604 0 0 1 2.603 2.603v6.944a2.604 2.604 0 0 1-2.603 2.604H3.39a2.604 2.604 0 0 1-2.604-2.604z"/><path fill="#2859c5" d="M10.967 3.353a.632.632 0 1 1-1.265 0a.632.632 0 0 1 1.265 0"/><path fill="#2859c5" fillRule="evenodd" d="M10.333 4.144a.75.75 0 1 0 0-1.5a.75.75 0 0 0 0 1.5M3.782 6.862a3.08 3.08 0 1 1 6.16 0a3.08 3.08 0 0 1-6.16 0" clipRule="evenodd"/></g></svg>,
                    link: "/inbox/instagram",
                },
                {
                    id: "inbox-whatsapp",
                    title: "WhatsApp",
                    icon: <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" className={iconCls}><g fill="none"><path fill="#8fbffa" fillRule="evenodd" d="M13.627 7.003C13.627 3.396 10.614.377 7 .379C3.39.381.38 3.394.38 7.003c0 1.213.336 2.412.968 3.449L.41 12.95a.5.5 0 0 0 .557.668l3.28-.593A6.6 6.6 0 0 0 7 13.62c3.614.002 6.627-3.008 6.627-6.618Z" clipRule="evenodd"/><path fill="#2859c5" d="M7.356 10.314c1.091.7 2.232.098 2.969-.498c.403-.326.39-.92.036-1.298l-.644-.685c-.193-.206-.524-.207-.785-.1c-.312.125-.68.163-.965.076c-.946-.288-1.343-.78-1.664-1.281c-.256-.399-.134-.934.073-1.333c.131-.253.124-.587-.087-.78l-.692-.631c-.329-.3-.827-.352-1.13-.025c-.757.817-1.264 2.16-.726 2.998c.919 1.43 2.185 2.638 3.615 3.557"/></g></svg>,
                    link: "/inbox/whatsapp",
                },
                {
                    id: "inbox-orders",
                    title: "Inbox Orders",
                    icon: <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" className={iconCls}><g fill="none"><path fill="#d7e0ff" d="M13.208 8h-3.22c-.55 0-.983.47-1.225.965C8.499 9.503 7.972 10 6.998 10s-1.5-.497-1.764-1.035C4.991 8.469 4.559 8 4.009 8H.789c.032.84.1 1.671.183 2.478a2.87 2.87 0 0 0 2.54 2.563c1.13.122 2.306.209 3.486.209s2.357-.087 3.486-.209a2.87 2.87 0 0 0 2.54-2.563A38 38 0 0 0 13.208 8"/><path fill="#fff" d="M13.04 3.731c.114 1.064.21 2.156.21 3.269l-.042 1h-3.22c-.55 0-.983.47-1.225.965C8.499 9.503 7.972 10 6.999 10c-.974 0-1.501-.497-1.765-1.035C4.992 8.469 4.56 8 4.01 8H.789L.75 7c0-1.113.096-2.205.21-3.269A3.13 3.13 0 0 1 3.713.971C4.783.853 5.88.75 7 .75s2.218.102 3.287.222a3.13 3.13 0 0 1 2.753 2.76"/><path stroke="#4147d5" strokeLinecap="round" strokeLinejoin="round" d="M13.04 3.731c.114 1.064.21 2.156.21 3.269l-.042 1h-3.22c-.55 0-.983.47-1.225.965C8.499 9.503 7.972 10 6.999 10c-.974 0-1.501-.497-1.765-1.035C4.992 8.469 4.56 8 4.01 8H.789L.75 7c0-1.113.096-2.205.21-3.269A3.13 3.13 0 0 1 3.713.971C4.783.853 5.88.75 7 .75s2.218.102 3.287.222a3.13 3.13 0 0 1 2.753 2.76"/><path stroke="#4147d5" strokeLinecap="round" strokeLinejoin="round" d="M13.208 8h-3.22c-.55 0-.983.47-1.225.965C8.499 9.503 7.972 10 6.998 10s-1.5-.497-1.764-1.035C4.991 8.469 4.559 8 4.009 8H.789c.032.84.1 1.671.183 2.478a2.87 2.87 0 0 0 2.54 2.563c1.13.122 2.306.209 3.486.209s2.357-.087 3.486-.209a2.87 2.87 0 0 0 2.54-2.563A38 38 0 0 0 13.208 8"/></g></svg>,
                    link: "/inbox/orders",
                },
            ],
        };
