...
export function DashboardLayout() {
    ...
    return (
        <SidebarProvider defaultOpen={true}>
            <div className="flex min-h-screen w-full bg-[#EBEBEB] text-[#202020]">
                <AppSidebar />
                <SidebarInset className="flex min-w-0 flex-col bg-transparent">
                    ...
                    <main className="mx-3 mb-3 min-w-0 flex-1 overflow-auto rounded-[18px] border border-black/10 bg-[#EBEBEB] shadow-[inset_0_1px_0_rgba(255,255,255,0.7)]">
                        <Outlet />
                    </main>
                </SidebarInset>
            </div>
