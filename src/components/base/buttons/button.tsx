...
const colorClasses: Record<ButtonColor, string> = {
  ...
  skeuomorphic: [
    "rounded-lg border-0 p-0 text-transparent shadow-[0_2px_8px_rgba(0,0,0,0.18)]",
...
const skeuomorphicOuter = "block w-full rounded-[inherit] transition-all duration-300 ease-linear shadow-[0_8px_28px_rgba(0,0,0,0.22)] group-hover/button:translate-y-px group-hover/button:shadow-[0_1px_2px_rgba(0,0,0,0.25),0_6px_12px_rgba(0,0,0,0.15)]";
