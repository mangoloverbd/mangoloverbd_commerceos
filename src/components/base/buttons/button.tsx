...
const skeuomorphicOuter = "block w-full rounded-[inherit] transition-all duration-300 ease-linear shadow-[0_2px_1px_rgba(0,0,0,0.3),0_12px_24px_rgba(0,0,0,0.18)] group-hover/button:translate-y-px group-hover/button:shadow-[0_1px_2px_rgba(0,0,0,0.25),0_6px_12px_rgba(0,0,0,0.15)]";
