...
import { ClipboardText, ChatCircle, Package, DotsThree } from "@phosphor-icons/react";
import { cn } from "@/lib/utils";

type MobileHomeIconProps = {
  size?: number;
  weight?: "light";
  "aria-hidden"?: boolean;
};

function MobileHomeIcon({ size = 21, ...props }: MobileHomeIconProps) {
  return (
    <svg
