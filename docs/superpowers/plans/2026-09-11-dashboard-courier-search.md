...
- [x] **Step 1: Add a failing dashboard search assertion**
...
- [x] **Step 2: Run the focused dashboard test and verify it fails**
...
- [x] **Step 3: Replace the inline field checks with the helper**
...
- [x] **Step 1: Run the full Merchant Suite test suite**
