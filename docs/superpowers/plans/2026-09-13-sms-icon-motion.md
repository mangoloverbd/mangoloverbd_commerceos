...
- [x] **Step 1: Add reduced-motion-aware animation**
...
- [x] **Step 2: Preserve the existing dialog contents**
...
- [x] **Step 3: Run focused dialog tests**
...
- [x] **Step 4: Commit the motion change**
