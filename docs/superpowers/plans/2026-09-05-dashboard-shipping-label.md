...
- [x] **Step 3: Add the barcode dependency and print logo**
...
- [x] **Step 1: Add a failing wiring/isolation test**
...
- [x] **Step 3: Wire the Dashboard action**
...
- [x] **Step 1: Review the branch diff**
...
- [x] **Step 2: Re-run completion verification**

Run: `npm test && npm run lint && npm run build && git diff --check main...HEAD`

Expected: all commands succeed.

- [x] **Step 3: Merge into local main**
...
- [x] **Step 4: Confirm local merge state**
